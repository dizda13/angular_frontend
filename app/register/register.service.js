...
var RegisterService = (function () {
    ...
    RegisterService.prototype.registerUser = function (username, first_name, last_name, email, password) {
        var _this = this;
        ...
        return this.http.post('https://realtimetalk.herokuapp.com/rest/dodaj', {
            ...
            last_name: last_name,
            email: email }, options).map(function (response) { return _this.response = response.json(); });
    };
